...
def get_run_count():
    try:
        with winreg.OpenKey(winreg.HKEY_CURRENT_USER, r'Software\flat_osv_1', 0, winreg.KEY_READ) as key:
...
def set_run_count(count):
    with winreg.CreateKey(winreg.HKEY_CURRENT_USER, r'Software\flat_osv_1') as key:
